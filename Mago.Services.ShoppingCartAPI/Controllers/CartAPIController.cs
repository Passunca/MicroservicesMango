    ...
    public class CartAPIController : ControllerBase
    {
        ...
        public async Task<ResponseDto> GetCart(string userId)
        {
            try
            {
                ...
                cart.CartDetails =
                    _mapper.Map<IEnumerable<CartDetailsDto>>(_db.CartDetails.Where(u => u.CartHeaderId == cart.CartHeader.CartHeaderId));
            ...
            try
            {
                ...
                else
                {
                    var cartDetailsFromDb =
                        await _db.CartDetails.AsNoTracking()
        ...
        public async Task<ResponseDto> RemoveCart([FromBody] int cartDetailsId)
        {
            try
            {
                CartDetails cartDetails =
                     _db.CartDetails.First(u => u.CartDetailsId == cartDetailsId);
